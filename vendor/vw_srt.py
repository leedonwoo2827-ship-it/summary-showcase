# -*- coding: utf-8 -*-
# ── 벤더링: voicewright/srt.py (260602-tech-historybook150) ─────────────────
# 손대지 않는다. 고칠 일이 생기면 원본에서 고치고 다시 복사한다.
# 큐 분할(문장→쉼표→hard-wrap)과 글자수 비례 타이밍이 여기 다 있다.
# ★ 타이밍은 강제정렬이 아니라 **추정**이다. 큐시트 초안으로 쓰고
#   정확한 싱크는 영상 편집에서 맞춘다.
